        ...
        switch(val){
            ...
            case 2://登録
                ...
                /////////ディレクトリの作成動作////////
                    ...
                    sprintf(dirnm,"client%s",Account.addr);
                    if(mkdir(dirnm,0777)==0){ //_mkdir("name")に変更
                        printf("ディレクトリ2作成に成功\n");
                    }else{
                        printf("ディレクトリ2作成できませんでした\n");
                    }
                ////////////////////////////////////
                    printf("作成に成功\n");
                fclose(fp);
                ...
                val1=atoi(to);
                    switch(val1){
                        ...
                        case 2://アカウント削除
                            ...
                            printf("%s",dirnm);////////////
                            if(rmdir(dirnm)==0){ //_mkdir("name")に変更
                                printf("　のディレクトリ削除に成功\n");
                            }else{
                                printf("　のディレクトリを削除できませんでした\n");
                            }
